...
from services.AllClasses import Query1API, Query2API, Query3API, Query4API, Query5API
from services.AllClasses import Query6API, Query7API, Query8API, Query9API, Query10API
