from services.query1 import Query1API
from services.query2 import Query2API
from services.query3 import Query3API
from services.query4 import Query4API
from services.query5 import Query5API
from services.query6 import Query6API
from services.query7 import Query7API
from services.query8 import Query8API
from services.query9 import Query9API
from services.query10 import Query10API
