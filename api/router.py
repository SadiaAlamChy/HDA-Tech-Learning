from service.queries import Query1API, Query2API, Query3API, Query4API, Query5API, Query6API, Query7API
...
# query_api.add_url_rule("/q8", view_func=Query1API.as_view("Get division wise total sales"))
# query_api.add_url_rule("/q9", view_func=Query1API.as_view("Get division wise total sales"))
# query_api.add_url_rule("/q10", view_func=Query1API.as_view("Get division wise total sales"))
